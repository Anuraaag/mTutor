...
--
-- Host: localhost
-- Generation Time: Jul 08, 2016 at 11:49 AM
...
CREATE TABLE IF NOT EXISTS `registration` (
  ...
  `user_type` char(1) NOT NULL,
  `mob_number` varchar(13) DEFAULT NULL,
  `ac_creation_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `activation_url` varchar(100) NOT NULL,
  `active_expiry_date` timestamp NULL DEFAULT NULL,
...
INSERT INTO `registration` (`id`, `name`, `email`, `password`, `user_type`, `mob_number`, `ac_creation_date`, `activation_url`, `active_expiry_date`, `active_status`) VALUES
(1, 'Sandeep Handa', 'sandeep.handa@gmail.com', '16d7a4fca7442dda3ad93c9a726597e4', 'T', NULL, '2016-07-07 09:24:16', 'DAG4AI6CMBAG3CT2C', NULL, 1),
(1, 'Madhurima', 'm@mail.com', '067afadb67dfda24bfbb395589863120', 'S', NULL, '2016-07-07 09:47:17', 'DAG4VIB7DU6YNI7F5', NULL, 1),
(1, 'Madhurima', 'madhu@gmail.com', '712c8f99d5c61e9f47a021462cd8444f', 'S', NULL, '2016-07-08 06:05:55', 'DAGYRFFJGW9JXG0A9', NULL, 0);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `last_logindate` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `u_id` varchar(7) NOT NULL,
  PRIMARY KEY (`u_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`name`, `email`, `password`, `user_type`, `mob_number`, `status`, `ac_creation_date`, `last_logindate`, `u_id`) VALUES
('Sandeep Handa', 'sandeep.handa@gmail.com', '16d7a4fca7442dda3ad93c9a726597e4', 'T', NULL, 1, '2016-07-07 14:55:25', '2016-07-07 09:25:25', 'T000001'),
('Madhurima', 'm@mail.com', '067afadb67dfda24bfbb395589863120', 'S', NULL, 1, '2016-07-07 15:18:31', '2016-07-07 09:48:31', 'S000001');
